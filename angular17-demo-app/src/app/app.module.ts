...
@NgModule({ declarations: [AppComponent, HeaderComponent, FooterComponent, SidenavComponent],
    bootstrap: [AppComponent], imports: [BrowserModule,
        ...
        CheckboxesCardModule], providers: [provideHttpClient(withInterceptorsFromDi())] })
