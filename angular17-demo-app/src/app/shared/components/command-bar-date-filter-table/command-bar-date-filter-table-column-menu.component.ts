...
import {Column} from './command-bar-date-filter-table.component';

@Component({
  selector: 'command-bar-date-filter-table-column-menu',
  styleUrls: ['./command-bar-date-filter-table-column-menu.component.scss'],
  templateUrl: './command-bar-date-filter-table-column-menu.component.html',
})
export class CommandBarDateFilterTableColumnMenuComponent {
