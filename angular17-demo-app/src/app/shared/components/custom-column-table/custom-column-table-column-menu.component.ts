...
import {Column} from './custom-column-table.component';

@Component({
  selector: 'custom-column-table-column-menu',
  styleUrls: ['./custom-column-table-column-menu.component.scss'],
  templateUrl: './custom-column-table-column-menu.component.html',
})
export class CustomColumnTableColumnMenuComponent {
