...
import {CommandBarTableComponent} from './command-bar-table.component';

import {CommandBarTableCommandBarComponent} from './command-bar-table-command-bar.component';
