...
import {Column} from './command-bar-table.component';

@Component({
  selector: 'command-bar-table-column-menu',
  styleUrls: ['./command-bar-table-column-menu.component.scss'],
  templateUrl: './command-bar-table-column-menu.component.html',
})
export class CommandBarTableColumnMenuComponent {
