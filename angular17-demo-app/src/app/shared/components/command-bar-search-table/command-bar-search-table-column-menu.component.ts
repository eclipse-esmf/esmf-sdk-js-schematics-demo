...
import {Column} from './command-bar-search-table.component';

@Component({
  selector: 'command-bar-search-table-column-menu',
  styleUrls: ['./command-bar-search-table-column-menu.component.scss'],
  templateUrl: './command-bar-search-table-column-menu.component.html',
})
export class CommandBarSearchTableColumnMenuComponent {
