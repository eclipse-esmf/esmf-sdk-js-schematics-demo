...
export class VersionSupportCardService {
  constructor(protected http: HttpClient, private translateService: TranslocoService) {
    this.http
      .get(
        `${baseUrl}/assets/i18n/shared/components/version-support-card/v210/${this.translateService.getActiveLang()}.version-support-card.translation.json`
      )
