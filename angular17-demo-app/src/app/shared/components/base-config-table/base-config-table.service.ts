...
export class BaseConfigTableService {
  constructor(protected http: HttpClient, private translateService: TranslocoService) {
    this.http
      .get(
        `${baseUrl}/assets/i18n/shared/components/base-config-table/${this.translateService.getActiveLang()}.base-config-table.translation.json`
      )
