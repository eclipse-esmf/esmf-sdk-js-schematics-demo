...
export class ExcludedPropertyCardService {
  constructor(protected http: HttpClient, private translateService: TranslocoService) {
    this.http
      .get(
        `${baseUrl}/assets/i18n/shared/components/excluded-property-card/${this.translateService.getActiveLang()}.excluded-property-card.translation.json`
      )
