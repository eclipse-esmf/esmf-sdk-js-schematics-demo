...
export class VersionSupportTableService {
  constructor(protected http: HttpClient, private translateService: TranslocoService) {
    this.http
      .get(
        `${baseUrl}/assets/i18n/shared/components/version-support-table/v210/${this.translateService.getActiveLang()}.version-support-table.translation.json`
      )
