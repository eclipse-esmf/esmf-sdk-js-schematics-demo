...
export class ExcludedPropertyTableService {
  constructor(protected http: HttpClient, private translateService: TranslocoService) {
    this.http
      .get(
        `${baseUrl}/assets/i18n/shared/components/excluded-property-table/${this.translateService.getActiveLang()}.excluded-property-table.translation.json`
      )
