...
export class DefaultSortingCardService {
  constructor(protected http: HttpClient, private translateService: TranslocoService) {
    this.http
      .get(
        `${baseUrl}/assets/i18n/shared/components/default-sorting-card/${this.translateService.getActiveLang()}.default-sorting-card.translation.json`
      )
