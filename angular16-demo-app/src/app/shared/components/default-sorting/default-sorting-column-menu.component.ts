...
import {Column} from './default-sorting.component';

@Component({
  selector: 'default-sorting-column-menu',
  styleUrls: ['./default-sorting-column-menu.component.scss'],
  templateUrl: './default-sorting-column-menu.component.html',
})
export class DefaultSortingColumnMenuComponent {
