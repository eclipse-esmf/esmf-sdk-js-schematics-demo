...
import {Column} from './checkboxes.component';

@Component({
  selector: 'checkboxes-column-menu',
  styleUrls: ['./checkboxes-column-menu.component.scss'],
  templateUrl: './checkboxes-column-menu.component.html',
})
export class CheckboxesColumnMenuComponent {
