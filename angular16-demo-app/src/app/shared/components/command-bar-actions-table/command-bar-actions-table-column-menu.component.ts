...
import {Column} from './command-bar-actions-table.component';

@Component({
  selector: 'command-bar-actions-table-column-menu',
  styleUrls: ['./command-bar-actions-table-column-menu.component.scss'],
  templateUrl: './command-bar-actions-table-column-menu.component.html',
})
export class CommandBarActionsTableColumnMenuComponent {
