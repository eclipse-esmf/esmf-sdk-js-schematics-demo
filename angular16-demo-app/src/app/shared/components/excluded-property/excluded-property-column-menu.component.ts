...
@Component({
  ...
  styleUrls: ['./excluded-property-column-menu.component.scss'],
  templateUrl: './excluded-property-column-menu.component.html',
})
export class ExcludedPropertyColumnMenuComponent {
