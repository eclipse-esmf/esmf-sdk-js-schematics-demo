...
import {CommandBarActionsCardComponent} from './command-bar-actions-card.component';
...
@NgModule({
  ...
  providers: [],
  exports: [CommandBarActionsCardComponent, CommandBarActionsCardCommandBarComponent, TranslateModule],
})
