...
import {Column} from './command-bar-enum-filter.component';
import {CdkDragDrop, moveItemInArray} from '@angular/cdk/drag-drop';
import {JSSdkLocalStorageService} from '../../services/storage.service';

@Component({
  selector: 'command-bar-enum-filter-column-menu',
  styleUrls: ['./command-bar-enum-filter-column-menu.component.scss'],
  templateUrl: './command-bar-enum-filter-column-menu.component.html',
})
export class CommandBarEnumFilterColumnMenuComponent {
