...
export const yFormControl = new FormControl(null, [Validators.required]);
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => YComponent),
      multi: true,
    },
  ],
})
export class YComponent extends FormControlReusable {
  formControl = yFormControl;
