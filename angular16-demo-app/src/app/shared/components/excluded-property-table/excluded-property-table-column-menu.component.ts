...
import {Column} from './excluded-property-table.component';

@Component({
  selector: 'excluded-property-table-column-menu',
  styleUrls: ['./excluded-property-table-column-menu.component.scss'],
  templateUrl: './excluded-property-table-column-menu.component.html',
})
export class ExcludedPropertyTableColumnMenuComponent {
