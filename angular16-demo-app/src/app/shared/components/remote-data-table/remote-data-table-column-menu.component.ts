...
import {Column} from './remote-data-table.component';

@Component({
  selector: 'remote-data-table-column-menu',
  styleUrls: ['./remote-data-table-column-menu.component.scss'],
  templateUrl: './remote-data-table-column-menu.component.html',
})
export class RemoteDataTableColumnMenuComponent {
