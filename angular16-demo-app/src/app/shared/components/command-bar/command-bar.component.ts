  ...
  openExportConfirmationDialog() {
    ...
    dialogRef
      ...
      .subscribe((event: {action: Action; exportAllPages: boolean; exportAllColumns: boolean}): void => {
        ...
        this.prepareCsv(this.commandBarService.flatten(this.data), event.exportAllColumns, event.exportAllPages, this.paginator.pageSize);
      });
  }
