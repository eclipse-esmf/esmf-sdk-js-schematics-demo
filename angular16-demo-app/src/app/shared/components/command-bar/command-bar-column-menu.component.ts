...
import {Column} from './command-bar.component';

@Component({
  selector: 'command-bar-column-menu',
  styleUrls: ['./command-bar-column-menu.component.scss'],
  templateUrl: './command-bar-column-menu.component.html',
})
export class CommandBarColumnMenuComponent {
