...
import {DefaultSortingCardFilterService, SortCard} from './default-sorting-card-filter.service';
...
@Component({
  selector: 'esmf-ui-default-sorting-card',
  templateUrl: './default-sorting-card.component.html',
  styleUrls: ['./default-sorting-card.component.scss'],

  encapsulation: ViewEncapsulation.None,
})
export class DefaultSortingCardComponent implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private defaultSortingCardService: DefaultSortingCardService,
    private filterService: DefaultSortingCardFilterService
  ) {
  ...
  getContext(data: Movement) {
    return {
      defaultSortingCardCardValues: this.defaultSortingCardCardValues,
      $implicit: data,
