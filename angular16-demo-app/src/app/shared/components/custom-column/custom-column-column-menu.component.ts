...
import {Column} from './custom-column.component';

@Component({
  selector: 'custom-column-column-menu',
  styleUrls: ['./custom-column-column-menu.component.scss'],
  templateUrl: './custom-column-column-menu.component.html',
})
export class CustomColumnColumnMenuComponent {
