...
import {FilterEnums, FilterType, VersionSupportFilterService} from './version-support-filter.service';

@Component({
  selector: 'chip-list',
  templateUrl: './version-support-chip-list.component.html',
  styleUrls: ['./version-support-chip-list.component.scss'],
})
export class VersionSupportChipListComponent {
