...
export class VersionSupportComponent implements OnInit, AfterViewInit, AfterViewChecked, OnChanges, OnDestroy {
  ...
  readonly KEY_LOCAL_STORAGE_VERSION_SUPPORT_V210_COLUMNS = 'version_support_v210_columns';

  readonly KEY_LOCAL_STORAGE_VERSION_SUPPORT_V210_CONFIG = 'version_support_v210_config';
  ...
  openExportConfirmationDialog() {
    ...
    dialogRef
      ...
      .subscribe((event: {action: Action; exportAllPages: boolean; exportAllColumns: boolean}): void => {
        ...
        this.prepareCsv(
          this.versionSupportService.flatten(this.data),
