...
import {Column} from './command-bar-search.component';

@Component({
  selector: 'command-bar-search-column-menu',
  styleUrls: ['./command-bar-search-column-menu.component.scss'],
  templateUrl: './command-bar-search-column-menu.component.html',
})
export class CommandBarSearchColumnMenuComponent {
