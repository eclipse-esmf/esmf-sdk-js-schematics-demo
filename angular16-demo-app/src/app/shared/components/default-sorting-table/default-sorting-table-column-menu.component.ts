...
import {Column} from './default-sorting-table.component';

@Component({
  selector: 'default-sorting-table-column-menu',
  styleUrls: ['./default-sorting-table-column-menu.component.scss'],
  templateUrl: './default-sorting-table-column-menu.component.html',
})
export class DefaultSortingTableColumnMenuComponent {
