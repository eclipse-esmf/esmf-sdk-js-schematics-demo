...
export class CheckboxesCardService {
  constructor(protected http: HttpClient, private translateService: TranslateService) {
    this.http
      .get(`${baseUrl}/assets/i18n/shared/components/checkboxes-card/${this.translateService.currentLang}.checkboxes-card.translation.json`)
