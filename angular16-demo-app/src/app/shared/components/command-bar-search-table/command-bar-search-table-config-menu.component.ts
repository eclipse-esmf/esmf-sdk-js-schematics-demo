...
@Component({
  selector: 'command-bar-search-table-config-menu',
  templateUrl: './command-bar-search-table-config-menu.component.html',
  styleUrls: ['./command-bar-search-table.component.scss'],
})
export class CommandBarSearchTableConfigMenuComponent {
