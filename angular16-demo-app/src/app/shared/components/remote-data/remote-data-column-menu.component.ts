...
import {Column} from './remote-data.component';

@Component({
  selector: 'remote-data-column-menu',
  styleUrls: ['./remote-data-column-menu.component.scss'],
  templateUrl: './remote-data-column-menu.component.html',
})
export class RemoteDataColumnMenuComponent {
