# Contribution Guideline ESMF SDK JS schematics demo

Thank you for your interest in contributing to the ESMF SDK JS schematics demo. Use this repository to contribute to
the SDK JS schematics demo as easy and transparent as possible, whether it is:
...
The ESMF SDK JS schematics demo is developed in the context of the [Eclipse Semantic Modeling
...
The ESMF SDK JS schematics demo is written in the Java Programming Language. Please have a look into our [Code
Conventions](CONVENTIONS.md).

## Versioning

We use Semantic Versioning to identify released versions of the ESMF SDK JS schematics demo. Semantic Versioning is
