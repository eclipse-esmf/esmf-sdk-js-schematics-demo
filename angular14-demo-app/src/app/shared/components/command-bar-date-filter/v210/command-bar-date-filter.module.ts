...
import {CommandBarDateFilterConfigMenuComponent} from 'src/app/shared/components/command-bar-date-filter/v210/command-bar-date-filter-config-menu.component';

@NgModule({
    declarations: [CommandBarDateFilterComponent, CommandBarDateFilterColumnMenuComponent, CommandBarDateFilterConfigMenuComponent],
    imports: [
        AppSharedModule,
