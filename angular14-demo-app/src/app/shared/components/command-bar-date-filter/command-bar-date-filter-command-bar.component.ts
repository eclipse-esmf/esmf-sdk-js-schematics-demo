...
@Component({
  ...
  templateUrl: './command-bar-date-filter-command-bar.component.html',
  styleUrls: [],
})
export class CommandBarDateFilterCommandBarComponent {
  @Input() isMultipleSelectionEnabled = true;
  @Input() allowedCharacters: string = '';
  @Input() minNumberCharacters: number = 2;
  @Input() maxNumberCharacters: number = 50;
  @Input() searchHint?: string;
  @Input() KEY_LOCAL_STORAGE_COMMAND_BAR_DATE_FILTER_CONFIG: string = '';
