...
import {RemoteDataConfigMenuComponent} from 'src/app/shared/components/remote-data/v210/remote-data-config-menu.component';

@NgModule({
    declarations: [RemoteDataComponent, RemoteDataColumnMenuComponent, RemoteDataConfigMenuComponent],
    imports: [
        AppSharedModule,
