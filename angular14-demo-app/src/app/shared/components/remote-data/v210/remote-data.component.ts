...
import {FilterEnums, RemoteDataFilterService} from './remote-data.filter.service';
...
import {RemoteDataConfigMenuComponent} from './remote-data-config-menu.component';
...
@Component({
    selector: 'rbs-ui-remote-data-v210',
...
export class RemoteDataComponent implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy {
    ...
    @ViewChild(RemoteDataConfigMenuComponent) private configurationComponent!: RemoteDataConfigMenuComponent;
    ...
    readonly KEY_LOCAL_STORAGE_REMOTE_DATA_V210_COLUMNS = 'remote_data_v210_columns';

    readonly KEY_LOCAL_STORAGE_REMOTE_DATA_V210_CONFIG = 'remote_data_v210_config';
    ...
    constructor(
        ...
        public filterService: RemoteDataFilterService,
    ...
    initializeColumns(): void {
        const configStorage = this.storageService.getItem(this.KEY_LOCAL_STORAGE_REMOTE_DATA_V210_CONFIG);
        const columnStorage = this.storageService.getItem(this.KEY_LOCAL_STORAGE_REMOTE_DATA_V210_COLUMNS);
    ...
    applyFilters(): void {
        ...
        try {
            this.remoteDataService.requestData(this.remoteAPI, {query: rqlStringTemp}).subscribe(
    ...
    downloadCsv(csvArray: any): void {
        ...
        try {
            this.remoteDataService.downloadCsv(csvArray);
    ...
    initOpenedColumnMenuDialog(): void {
        this.columMenuComponent.keyLocalStorage = this.KEY_LOCAL_STORAGE_REMOTE_DATA_V210_COLUMNS;
    ...
    initOpenedConfigurationDialog(): void {
        this.configurationComponent.keyLocalStorage = this.KEY_LOCAL_STORAGE_REMOTE_DATA_V210_CONFIG;
