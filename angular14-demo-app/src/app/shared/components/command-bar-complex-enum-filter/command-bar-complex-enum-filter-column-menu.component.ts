...
import {Column} from './command-bar-complex-enum-filter.component';
import {CdkDragDrop, moveItemInArray} from '@angular/cdk/drag-drop';
import {JSSdkLocalStorageService} from '../../services/storage.service';

@Component({
    selector: 'command-bar-complex-enum-filter-column-menu',
...
export class CommandBarComplexEnumFilterColumnMenuComponent {
