...
import {CommandBarEnumFilterFilterService, FilterEnums} from './command-bar-enum-filter.filter.service';
...
@Component({
  selector: 'esmf-ui-command-bar-enum-filter-v210',
  templateUrl: './command-bar-enum-filter.component.html',
  styleUrls: ['./command-bar-enum-filter.component.scss'],
})
export class CommandBarEnumFilterComponent implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy {
  ...
  @ViewChild(CommandBarEnumFilterConfigMenuComponent) private configurationComponent!: CommandBarEnumFilterConfigMenuComponent;
  ...
  readonly KEY_LOCAL_STORAGE_COMMAND_BAR_ENUM_FILTER_V210_COLUMNS = 'command_bar_enum_filter_v210_columns';

  readonly KEY_LOCAL_STORAGE_COMMAND_BAR_ENUM_FILTER_V210_CONFIG = 'command_bar_enum_filter_v210_config';
  ...
  initializeColumns(): void {
    const configStorage = this.storageService.getItem(this.KEY_LOCAL_STORAGE_COMMAND_BAR_ENUM_FILTER_V210_CONFIG);
    const columnStorage = this.storageService.getItem(this.KEY_LOCAL_STORAGE_COMMAND_BAR_ENUM_FILTER_V210_COLUMNS);
  ...
  initOpenedColumnMenuDialog(): void {
    this.columMenuComponent.keyLocalStorage = this.KEY_LOCAL_STORAGE_COMMAND_BAR_ENUM_FILTER_V210_COLUMNS;
  ...
  initOpenedConfigurationDialog(): void {
    this.configurationComponent.keyLocalStorage = this.KEY_LOCAL_STORAGE_COMMAND_BAR_ENUM_FILTER_V210_CONFIG;
