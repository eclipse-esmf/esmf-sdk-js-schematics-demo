...
import {FilterEnums, ComplexPropSelectedFilterService} from './complex-prop-selected.filter.service';
...
@Component({
    selector: 'esmf-ui-complex-prop-selected-v210',
    templateUrl: './complex-prop-selected.component.html',
    styleUrls: ['./complex-prop-selected.component.scss'],
})
export class ComplexPropSelectedComponent implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy {
    ...
    @ViewChild(ComplexPropSelectedConfigMenuComponent) private configurationComponent!: ComplexPropSelectedConfigMenuComponent;
    ...
    readonly KEY_LOCAL_STORAGE_COMPLEX_PROP_SELECTED_V210_COLUMNS = 'complex_prop_selected_v210_columns';

    readonly KEY_LOCAL_STORAGE_COMPLEX_PROP_SELECTED_V210_CONFIG = 'complex_prop_selected_v210_config';
    ...
    initializeColumns(): void {
        const configStorage = this.storageService.getItem(this.KEY_LOCAL_STORAGE_COMPLEX_PROP_SELECTED_V210_CONFIG);
        const columnStorage = this.storageService.getItem(this.KEY_LOCAL_STORAGE_COMPLEX_PROP_SELECTED_V210_COLUMNS);
        ...
        this.displayedColumns.forEach((displayedColumn: string): void => {
            if (
                displayedColumn === ComplexPropSelectedColumn['COLUMNS_MENU'] ||
    ...
    initOpenedColumnMenuDialog(): void {
        this.columMenuComponent.keyLocalStorage = this.KEY_LOCAL_STORAGE_COMPLEX_PROP_SELECTED_V210_COLUMNS;
    ...
    initOpenedConfigurationDialog(): void {
        this.configurationComponent.keyLocalStorage = this.KEY_LOCAL_STORAGE_COMPLEX_PROP_SELECTED_V210_CONFIG;
