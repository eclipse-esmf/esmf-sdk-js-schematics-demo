...
@Component({
    selector: 'esmf-ui-command-bar-search-v210',
    templateUrl: './command-bar-search.component.html',
    styleUrls: ['./command-bar-search.component.scss'],
})
export class CommandBarSearchComponent implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy {
    ...
    readonly KEY_LOCAL_STORAGE_COMMAND_BAR_SEARCH_V210_COLUMNS = 'command_bar_search_v210_columns';

    readonly KEY_LOCAL_STORAGE_COMMAND_BAR_SEARCH_V210_CONFIG = 'command_bar_search_v210_config';
    ...
    initializeColumns(): void {
        const configStorage = this.storageService.getItem(this.KEY_LOCAL_STORAGE_COMMAND_BAR_SEARCH_V210_CONFIG);
        const columnStorage = this.storageService.getItem(this.KEY_LOCAL_STORAGE_COMMAND_BAR_SEARCH_V210_COLUMNS);
        ...
        this.displayedColumns.forEach((displayedColumn: string): void => {
            if (
                displayedColumn === CommandBarSearchColumn['COLUMNS_MENU'] ||
    ...
    initOpenedColumnMenuDialog(): void {
        this.columMenuComponent.keyLocalStorage = this.KEY_LOCAL_STORAGE_COMMAND_BAR_SEARCH_V210_COLUMNS;
    ...
    initOpenedConfigurationDialog(): void {
        this.configurationComponent.keyLocalStorage = this.KEY_LOCAL_STORAGE_COMMAND_BAR_SEARCH_V210_CONFIG;
