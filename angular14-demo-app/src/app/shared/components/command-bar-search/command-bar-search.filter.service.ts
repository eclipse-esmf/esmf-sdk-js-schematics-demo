...
export class CommandBarSearchFilterService {
                  ...
                  searchFilters.forEach((filter: any): void => {
                      if (filter.prop === this.advancedSearchAllValue) {
                          this.stringColumns.forEach(elem => {
                              if (
                                  this.getValueByAccessPath(elem, item).toLocaleLowerCase().includes(filter.filterValue.toLocaleLowerCase())
                              ) {
                          ...
                          if (
                              this.getValueByAccessPath(filter.prop, item)
                                  .toLocaleLowerCase()
