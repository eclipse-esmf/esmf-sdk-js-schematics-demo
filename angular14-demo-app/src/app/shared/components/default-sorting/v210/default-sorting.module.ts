...
import {DefaultSortingConfigMenuComponent} from 'src/app/shared/components/default-sorting/v210/default-sorting-config-menu.component';

@NgModule({
    declarations: [DefaultSortingComponent, DefaultSortingColumnMenuComponent, DefaultSortingConfigMenuComponent],
    imports: [
        AppSharedModule,
