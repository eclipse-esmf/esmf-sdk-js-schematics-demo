...
import {DefaultSortingService, MovementResponse} from './default-sorting.service';
...
export class DefaultSortingComponent implements OnInit, AfterViewInit, AfterViewChecked, OnChanges {
    ...
    readonly KEY_LOCAL_STORAGE_DEFAULT_SORTING_COLUMNS = 'default_sorting_columns';
    ...
    constructor(
        ...
        this.dataSource = new DefaultSortingDataSource(this.translateService);
    ...
    initializeColumns(): void {
        const columnStorage = this.storageService.getItem(this.KEY_LOCAL_STORAGE_DEFAULT_SORTING_COLUMNS);
    ...
    openExportConfirmationDialog() {
        ...
        dialogRef
            ...
            .subscribe((exportEvent: {exportAllPages: boolean; exportAllColumns: boolean}): void => {
                ...
                this.prepareCsv(this.defaultSortingService.flatten(this.data), exportAllColumns, exportAllPages, this.paginator.pageSize);
            });
    }
    ...
    initOpenedColumnMenuDialog(): void {
        this.columMenuComponent.keyLocalStorage = this.KEY_LOCAL_STORAGE_DEFAULT_SORTING_COLUMNS;
