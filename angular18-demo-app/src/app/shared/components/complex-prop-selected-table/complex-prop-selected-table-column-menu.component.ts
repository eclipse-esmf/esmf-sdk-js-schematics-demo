...
import {Column} from './complex-prop-selected-table.component';

@Component({
  selector: 'complex-prop-selected-table-column-menu',
  styleUrls: ['./complex-prop-selected-table-column-menu.component.scss'],
  templateUrl: './complex-prop-selected-table-column-menu.component.html',
})
export class ComplexPropSelectedTableColumnMenuComponent {
