...
@Component({
  selector: 'command-bar-table-command-bar',
  templateUrl: './command-bar-table-command-bar.component.html',
  styleUrls: ['./command-bar-table-command-bar.component.scss'],
})
export class CommandBarTableCommandBarComponent implements AfterViewInit {
  ...
  @Input() KEY_LOCAL_STORAGE_COMMAND_BAR_TABLE_CONFIG: string = '';
