...
import {FilterEnums, FilterType, VersionSupportCardFilterService} from './version-support-card-filter.service';

@Component({
  selector: 'version-support-card-chip-list',
  templateUrl: './version-support-card-chip-list.component.html',
  styleUrls: ['./version-support-card-chip-list.component.scss'],
})
export class VersionSupportCardChipListComponent {
