...
@Component({
  selector: 'version-support-card-command-bar',
  templateUrl: './version-support-card-command-bar.component.html',
  styleUrls: ['./version-support-card-command-bar.component.scss'],
})
export class VersionSupportCardCommandBarComponent implements AfterViewInit {
  ...
  constructor(public filterService: VersionSupportCardFilterService, public dialog: MatDialog) {
