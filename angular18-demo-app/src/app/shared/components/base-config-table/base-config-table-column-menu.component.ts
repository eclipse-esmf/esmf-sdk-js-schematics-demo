...
import {Column} from './base-config-table.component';

@Component({
  selector: 'base-config-table-column-menu',
  styleUrls: ['./base-config-table-column-menu.component.scss'],
  templateUrl: './base-config-table-column-menu.component.html',
})
export class BaseConfigTableColumnMenuComponent {
