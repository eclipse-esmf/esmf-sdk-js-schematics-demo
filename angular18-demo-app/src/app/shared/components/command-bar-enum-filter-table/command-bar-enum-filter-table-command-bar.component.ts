...
@Component({
  selector: 'command-bar-enum-filter-table-command-bar',
  templateUrl: './command-bar-enum-filter-table-command-bar.component.html',
  styleUrls: ['./command-bar-enum-filter-table-command-bar.component.scss'],
})
export class CommandBarEnumFilterTableCommandBarComponent implements AfterViewInit {
  ...
  @Input() KEY_LOCAL_STORAGE_COMMAND_BAR_ENUM_FILTER_TABLE_CONFIG: string = '';
  ...
  constructor(public filterService: CommandBarEnumFilterTableFilterService, public dialog: MatDialog) {}
