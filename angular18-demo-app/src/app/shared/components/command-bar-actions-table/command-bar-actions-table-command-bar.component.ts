...
@Component({
  selector: 'command-bar-actions-table-command-bar',
  templateUrl: './command-bar-actions-table-command-bar.component.html',
  styleUrls: ['./command-bar-actions-table-command-bar.component.scss'],
})
export class CommandBarActionsTableCommandBarComponent implements AfterViewInit {
  ...
  @Input() KEY_LOCAL_STORAGE_COMMAND_BAR_ACTIONS_TABLE_CONFIG: string = '';
