...
export class ComplexPropSelectedCardService {
  constructor(protected http: HttpClient, private translateService: TranslocoService) {
    this.http
      .get(
        `${baseUrl}/assets/i18n/shared/components/complex-prop-selected-card/${this.translateService.getActiveLang()}.complex-prop-selected-card.translation.json`
      )
