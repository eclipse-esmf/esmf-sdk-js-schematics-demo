...
import {Column} from './row-action-button-table.component';

@Component({
  selector: 'row-action-button-table-column-menu',
  styleUrls: ['./row-action-button-table-column-menu.component.scss'],
  templateUrl: './row-action-button-table-column-menu.component.html',
})
export class RowActionButtonTableColumnMenuComponent {
