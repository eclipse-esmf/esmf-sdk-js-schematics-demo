...
@Component({
  selector: 'command-bar-search-card-command-bar',
...
export class CommandBarSearchCardCommandBarComponent implements AfterViewInit {
  ...
  constructor(public filterService: CommandBarSearchCardFilterService, public dialog: MatDialog) {
