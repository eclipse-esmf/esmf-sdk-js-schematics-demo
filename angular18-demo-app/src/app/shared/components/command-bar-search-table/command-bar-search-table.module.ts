...
import {CommandBarSearchTableComponent} from './command-bar-search-table.component';

import {CommandBarSearchTableCommandBarComponent} from './command-bar-search-table-command-bar.component';

import {CommandBarSearchTableChipListComponent} from './command-bar-search-table-chip-list.component';
