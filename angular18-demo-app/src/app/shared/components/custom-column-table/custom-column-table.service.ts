...
export class CustomColumnTableService {
  constructor(protected http: HttpClient, private translateService: TranslocoService) {
    this.http
      .get(
        `${baseUrl}/assets/i18n/shared/components/custom-column-table/${this.translateService.getActiveLang()}.custom-column-table.translation.json`
      )
