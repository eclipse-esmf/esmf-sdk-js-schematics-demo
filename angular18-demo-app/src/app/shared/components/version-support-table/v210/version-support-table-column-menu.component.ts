...
import {Column} from './version-support-table.component';

@Component({
  selector: 'version-support-table-column-menu',
  styleUrls: ['./version-support-table-column-menu.component.scss'],
  templateUrl: './version-support-table-column-menu.component.html',
})
export class VersionSupportTableColumnMenuComponent {
